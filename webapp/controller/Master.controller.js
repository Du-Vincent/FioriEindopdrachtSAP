...
sap.ui.define([
    ...
    return BaseController.extend("be.ap.product.controller.Master", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "be.ap.product.view.ViewSettingsDialog",
                    controller: this
        ...
        onSelectionChange: function (oEvent) {
            ...
            // when updating a product, remove ability to open other products
            if (!blocked) {
